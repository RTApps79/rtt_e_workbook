...
export const ORGAN_SITES = [
  { id: 'brain',        label: 'Brain',              color: 0xff4136, yFrac: 0.955, xFrac: 0,      zFrac: 0.05,  radiusFrac: 0.045 },
  { id: 'breast_l',      label: 'Breast (L)',         color: 0xff851b, yFrac: 0.735, xFrac: -0.16,  zFrac: 0.16,  radiusFrac: 0.035 },
  { id: 'breast_r',      label: 'Breast (R)',         color: 0xff851b, yFrac: 0.735, xFrac:  0.16,  zFrac: 0.16,  radiusFrac: 0.035 },
  { id: 'lung_l',        label: 'Lung (L)',           color: 0xffdc00, yFrac: 0.715, xFrac: -0.14,  zFrac: 0.02,  radiusFrac: 0.05  },
  { id: 'lung_r',        label: 'Lung (R)',           color: 0xffdc00, yFrac: 0.715, xFrac:  0.14,  zFrac: 0.02,  radiusFrac: 0.05  },
  { id: 'pancreas',      label: 'Pancreas',           color: 0x2ecc40, yFrac: 0.585, xFrac: -0.04,  zFrac: -0.03, radiusFrac: 0.035 },
  { id: 'colon',         label: 'Colon',              color: 0x01ff70, yFrac: 0.48,  xFrac:  0.10,  zFrac: 0.05,  radiusFrac: 0.04  },
  { id: 'prostate',      label: 'Prostate',           color: 0x0074d9, yFrac: 0.415, xFrac: 0,      zFrac: -0.02, radiusFrac: 0.03  },
  { id: 'endometrium',   label: 'Endometrium',        color: 0xb10dc9, yFrac: 0.415, xFrac: 0,      zFrac: 0.03,  radiusFrac: 0.03  },
  { id: 'spine_c',       label: 'Spine (Cervical)',   color: 0x7fdbff, yFrac: 0.90,  xFrac: 0,      zFrac: -0.09, radiusFrac: 0.025 },
  { id: 'spine_t',       label: 'Spine (Thoracic)',   color: 0x7fdbff, yFrac: 0.70,  xFrac: 0,      zFrac: -0.10, radiusFrac: 0.03  },
  { id: 'spine_l',       label: 'Spine (Lumbar)',     color: 0x7fdbff, yFrac: 0.48,  xFrac: 0,      zFrac: -0.09, radiusFrac: 0.03  },
  { id: 'femur_l',       label: 'Femur (L)',          color: 0xdddddd, yFrac: 0.26,  xFrac: -0.09,  zFrac: 0,     radiusFrac: 0.035 },
  { id: 'femur_r',       label: 'Femur (R)',          color: 0xdddddd, yFrac: 0.26,  xFrac:  0.09,  zFrac: 0,     radiusFrac: 0.035 },
];
